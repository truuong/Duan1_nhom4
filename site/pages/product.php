                                ...
                                <div class="single-popular-items mb-50 text-center">
                                    <div class="popular-img">
                                        ...
                                        <form action="index.php?page=addcart" method="post">
                                            ...
                                            <button type="submit"  name="addcart" onclick="return confirm('."'".'  Thêm Thành Công'."'".')" >
                                            <span style="width:200px; margin:-8px -8px">Thêm Giỏ Hàng</span>
                                            </button>
                                        </form>
                                    ...
                                    <div class="popular-caption">
                                        <h3><a href="product_details.html">' . $name . '</a></h3>
                                        <span>' . $price . ' VND</span>
                                    </div>
                                </div>
                            </div>
